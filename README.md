...
## Overview
A high-performance backend microservice built with Node.js and Express designed to automate the generation, storage, and distribution of digital receipts. This system utilizes a producer-consumer architecture with BullMQ and Redis to handle PDF generation and email delivery asynchronously, ensuring zero latency during the checkout process.
...
EMAIL_FROM=Hides Luxury <noreply@hidesluxury.com>
```
